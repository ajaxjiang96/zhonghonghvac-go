...
type ACBatchClient interface {
	...
	BatchTempControl(devices []string, value uint) (results *protocol.ACControlResponse, err error)
...
type ACClient interface {
	...
	TempControl(addr string, value uint) (results *protocol.ACControlResponse, err error)
